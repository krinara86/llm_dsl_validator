...
class LionWebConnectorLoader:
    ...
    def __init__(self, project_root: Path = None):
        ...
        # Create the cycling language programmatically
        self._create_cycling_language()
    
    def _create_cycling_language(self):
        """Create the cycling language programmatically using LionWeb classes."""
        # Create the language
        ...
        # Add properties to Rider (set optional as attribute, not constructor param)
        rider_name = Property(
            name="name",
            key="Rider-name",
            id="Rider-name-id",
            type=LionCoreBuiltins.get_string()
        )
        ...
        rider_age = Property(
            ...
            key="Rider-age",
            id="Rider-age-id",
            type=LionCoreBuiltins.get_integer()
        )
        rider_age.optional = True
        
        rider_country = Property(
            name="country",
            key="Rider-country",
            id="Rider-country-id",
            type=LionCoreBuiltins.get_string()
        ...
        # Add containments to Model (Containment DOES have optional parameter)
        riders_containment = Containment(
            name="riders",
            key="Model-riders",
            id="Model-riders-id",
            type=rider_concept,
        ...
        # Store the language and concepts
        self.languages["cycling"] = cycling_lang
        self.concepts["Model"] = model_concept
        self.concepts["Rider"] = rider_concept
        self.concepts["Team"] = team_concept
    ...
    def load_all(self, domain: str = "cycling") -> Dict[str, Any]:
        ...
        """
        results = {
            "language": "Created programmatically using LionWeb classes",
            "connector": None,
            "models": [],
            "errors": []
        }
